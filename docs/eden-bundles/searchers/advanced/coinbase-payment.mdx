...
* You can pay for a transaction from account X with ETH from account Y (see also: [searcher sponsored transaction repo](https://github.com/flashbots/searcher-sponsored-tx))
