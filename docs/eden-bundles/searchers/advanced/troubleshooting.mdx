...
1. A reverting transaction (unless specified via [optional argument revertingTxHashes](/eden-bundles/miners/mev-relay/#eth_sendbundle) or uncle'd)
2. [Gas price below base fee](/eden-bundles/searchers/advanced/eip1559#faq) (would create an invalid block if included)
