---
title: Troubleshooting Bundles
description: How to troubleshoot your bundle not landing on-chain
---
...
As a part of debugging we _strongly_ recommend that you simulate your transactions, log the output, as well as keep a record of all the data you submit including your entire bundle and its signed transactions.
...
Eden will _not_ include a bundle with
