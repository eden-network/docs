...
For advanced users, you can interact with the relay's RPC endpoint at `api.edennetwork.io/v1/bundle`. The relay provides new JSON-RPC methods for interfacing with Eden which are documented below:
