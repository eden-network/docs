...
4. 👀 [**Eden Bundler**](./eden-bundler/overview) A **NEW** public alpha bundler endpoint for wallets, dApps, SDKs, and users to implement [Account Abstraction](https://eips.ethereum.org/EIPS/eip-4337)
